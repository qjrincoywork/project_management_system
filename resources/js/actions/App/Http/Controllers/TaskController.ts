...
* @see app/Http/Controllers/TaskController.php:45
* @route '/tasks/create'
*/
...
* @see app/Http/Controllers/TaskController.php:56
* @route '/tasks'
*/
...
* @see app/Http/Controllers/TaskController.php:72
...
* @see app/Http/Controllers/TaskController.php:80
* @route '/tasks/{task}'
*/
...
* @see app/Http/Controllers/TaskController.php:88
* @route '/tasks/{task}'
*/
...
const TaskController = { index, create, store, show, edit, update, destroy }
